...
لطفاً مبلغ قابل پرداخت را به شماره کارت زیر واریز کنید:
...
💵 باقی‌مانده قابل پرداخت: {difference:,} تومان
...
از کیف پول استفاده می‌کنید؟
""",

    "referral_bound_notice": """

تخفیف معرفی برای شما فعال شد.
روی اولین خرید اشتراک، ۱۵٪ از مبلغ کم می‌شود.
""",

    "referral_eligible_notice": """

تخفیف معرفی شما فعال است: ۱۵٪ روی اولین خرید اشتراک.
""",

    "referral_plans_hint": """
تخفیف معرفی فعال است — در تایید سفارش، قیمت با ۱۵٪ کاهش نشان داده می‌شود.
...
{status_line}
با لینک بالا، دوست‌تان با اولین خرید ۱۵٪ تخفیف می‌گیرد.
بعد از پرداخت موفق همان خرید، ۲۰٪ مبلغ اصلی پلن به کیف پول شما واریز می‌شود.
تمدید شامل تخفیف یا پاداش نیست.
""",

    "referral_status_active": "وضعیت تخفیف شما: فعال (۱۵٪ روی اولین خرید)",
    "referral_status_used": "وضعیت تخفیف شما: استفاده شده",
    "referral_status_none": "شما هنوز از طریق دعوت وارد نشده‌اید؛ می‌توانید دیگران را دعوت کنید.",

    "referral_cashback_notify": """
پاداش معرفی واریز شد.

از اولین خرید دعوت‌شده شما، ۲۰٪ به کیف پول‌تان اضافه شد.
💰 مبلغ: {amount:,} تومان
""",
